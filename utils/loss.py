    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            for i, pi in enumerate(p):
                ...
                from_which_layer.append((torch.ones(size=(len(b),)) * i).to(torch.device(divice)))
            ...
            fg_mask_inboxes = fg_mask_inboxes.to(torch.device(divice)) #################################################
    ...
    def __call__(self, p, targets, imgs):  # predictions, targets, model   
        ...
        for i in range(self.nl):  # layer index, layer predictions
            ...
            if n:
                ...
                iou = bbox_iou(pbox.T, selected_tbox, x1y1x2y2=False)  # iou(prediction, target)
                iou_aux = bbox_iou(pbox_aux.T, selected_tbox_aux, x1y1x2y2=False)  # iou(prediction, target)
