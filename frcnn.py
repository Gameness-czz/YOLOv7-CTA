...
class FRCNN(object):
    _defaults = {
        ...
        "classes_path": 'model_data/voc_names.txt',
        # ---------------------------------------------------------------------#
    ...
    def __init__(self, **kwargs):
        ...
        self.colors = [(219, 112, 147), (255, 20, 147), (218, 112, 214), (153, 50, 204), (65, 105, 225),
    ...
    def detect_image(self, image, crop=False, count=False):
        ...
        font = ImageFont.truetype(font='arial.ttf',
                                  size=np.floor(1.9e-2 * image.size[1]).astype('int32'))
        # size=max(round(max(image.size) / 40), 12))
        ...
        for i, c in list(enumerate(top_label)):
            ...
            draw.text(text_origin, str(label, 'UTF-8'), fill=(225, 255, 255), font=font)
            del draw
